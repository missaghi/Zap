...
Getting this to work took a lot of and trial and error, so I wanted to collect the end result into a tutorial that might save someone some time. A lot of the tutorials i found on openVPN on windows were either outdated or not quite my use case which made things tricky. I have a feeling the information is actively obfuscated so that barrier to entry will persuade you to go with one of the fee based VPN providers, aka third parties.
